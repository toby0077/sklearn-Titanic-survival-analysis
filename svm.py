...
'''
svc:
accuracy on the training subset:0.796
accuracy on the test subset:0.710
'''
...
'''
accuracy on the scaled training subset:0.881
accuracy on the scaled test subset:0.845
'''
#改变C参数，调优,kernel表示核函数，用于平面转换，probability表示是否需要计算概率
...
'''
after c parameter=10,accuracy on the scaled training subset:0.886
after c parameter=10,accuracy on the scaled test subset:0.854
'''